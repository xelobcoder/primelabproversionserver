...
exports.handlergetAllTestYearlyAnalysis = exports.handlergetTestMonthlyCountForYear = exports.handlergetTestTotalCasesMonthDaily = exports.handlerTestTotalCasesCount = void 0;
...
async function handlerTestTotalCasesCount(request, response) {
    try {
        ...
        if (!employeeid || !testid) {
            throw new Error('employeeid and testid required');
        }
