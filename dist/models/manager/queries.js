...
exports.insertApprovalQuery = exports.getReadyForApprovalsQuery = exports.getRoleQuery = void 0;
exports.getRoleQuery = `
  SELECT * FROM roles WHERE employeeid = ?
`;
exports.getReadyForApprovalsQuery = `
  SELECT
    ta.testid,
    ta.billingid,
