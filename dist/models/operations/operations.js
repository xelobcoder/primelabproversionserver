...
class Operations {
    ...
    constructor(billingid) {
         ...
         * @returns {Promise<number>} - A promise that resolves to the number of rows affected.
         */
        this.logResultEntryIntoAscensionTable = async (testid, billingid) => {
     ...
     */
    async getLaboratoryTestReadyForResultEntry(departmentid, branchid) {
    ...
    async getAllQualifiedToProcessByDepartment(category, count, page, branchid) {
        try {
